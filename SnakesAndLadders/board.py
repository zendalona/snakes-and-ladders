...
class Board:
    def __init__(self, board_num,diff):
        ...
        if board_num == 5:
            self.ladder_coordinates = [ [(5,23)],[(12,34)],[(20,45)],[(32,51)],[(43,62)],[(61,82)],[(68,91)],[(54,76)],[(98,64)]]
            self.board_color=[[(0.5,0.4,0.5),(1,1,1)]]
            self.snake_heads=[[(15,2),(1,0.3,0.2)],[(30,8),(0.2,0.5,0.6)],[(36,18),(0.6,1,0.6)],[ (46,27),(0.4,0.3,0.6)],[(74,56),(0.3,0.3,0.9)],
                                [(78,42),(0.7,0.3,0.6)] ,[(85,65),(0.4,0.9,0.3)],[(90,48),(0.3,0.8,0.5)],[(95,77),(1,0,0.6)]]
